...
class Task(_BaseEvergreenObject):
    ...
    long_term_date = evg_attrib("long_term_date")
    long_term_num_swaps = evg_attrib("long_term_num_swaps")
    ...
    short_term_date = evg_attrib("short_term_date")
    short_term_num_swaps = evg_attrib("short_term_num_swaps")
